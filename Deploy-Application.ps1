...
Try {
	...
	[string]$appName = 'Realtek Audio Driver - 7470'
	[string]$appVersion = '6.0.1.6125'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '09/19/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\Realtek-High-Definition-Audio-Driver_XV22H_WIN_6.0.1.6125_A10.EXE" -Parameters '/s' -WindowStyle 'Hidden' -PassThru
